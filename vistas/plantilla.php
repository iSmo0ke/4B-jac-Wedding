...
<head>
   ...
   <!--Favicon img-->
   <link rel=plantilla href=C:\xampp\htdocs\WEB-4A\vistas>
   ...
   <div class="container">
      <div class="header-wrapper">
         ...
         <ul class="main-menu">
            ...
            <li>
               <a href="#0">Sign Up<i class="fas fa-chevron-down"></i></a>
               <ul class="sub-menu">
                  
                  <?php if (isset($_GET["pagina"])) : ?>
                     <?php if ($_GET["pagina"] == "registro"): ?>
                           <li class="nav-item">
                              <a class="nav-link active" href="index.php?pagina=registro">Sing up</a>
                           </li>
                     <?php else: ?>
                           <li class="nav-item">
                              <a class="nav-link" href="index.php?pagina=registro">Sing up</a>
                           </li>
                     <?php endif ?>
                     ...
                     <?php if ($_GET["pagina"] == "inicio") : ?>
                           <li class="nav-item">
                              <a class="nav-link active" href="index.php?pagina=inicio">Table home</a>
                           </li>
                     <?php else: ?>
                           <li class="nav-item">
                              <a class="nav-link" href="index.php?pagina=inicio">Table home</a>
                           </li>
                     <?php endif ?>

                     <?php if ($_GET["pagina"] == "salir") : ?>
                           <li class="nav-item">
                              <a class="nav-link active" href="index.php?pagina=salir">Log out</a>
                           </li>
                     <?php else: ?>
                           <li class="nav-item">
                  ...
                  <?php else: ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?pagina=salir.php">Log out</a>
                    </li>
                <?php endif ?>
            ...
            <li <?= isset($_GET["pagina"]) && $_GET["pagina"] == "index" ? 'class="active"' : '' ?>>
               <a href="index.php?pagina=index">Home</a>
            </li>
            <li <?= isset($_GET["pagina"]) && $_GET["pagina"] == "about" ? 'class="active"' : '' ?>>
               <a href="index.php?pagina=about">About</a>
            </li>
            <li>
               <a href="#0">Service <i class="fas fa-chevron-down"></i></a>
               <ul class="sub-menu">
                  <li <?= isset($_GET["pagina"]) && $_GET["pagina"] == "service" ? 'class="subtwohober"' : '' ?>>
                     <a href="index.php?pagina=service">
                        <span>Service</span>
                     </a>
                  </li>
                  <li <?= isset($_GET["pagina"]) && $_GET["pagina"] == "service-single" ? 'class="subtwohober"' : '' ?>>
            ...
            <li <?= isset($_GET["pagina"]) && $_GET["pagina"] == "story" ? 'class="active"' : '' ?>>
               <a href="index.php?pagina=story">Our story</a>
            </li>
            <li>
               <a href="#0">Pages <i class="fas fa-chevron-down"></i></a>
               <ul class="sub-menu">
                  <li <?= isset($_GET["pagina"]) && $_GET["pagina"] == "event" ? 'class="subtwohober"' : '' ?>>
                     <a href="index.php?pagina=event">
                        <span>Our event</span>
                     </a>
                  </li>
                  <li <?= isset($_GET["pagina"]) && $_GET["pagina"] == "gallery" ? 'class="subtwohober"' : '' ?>>
                     <a href="index.php?pagina=gallery">
                        <span>Gallery</span>
                     </a>
                  </li>
                  <li <?= isset($_GET["pagina"]) && $_GET["pagina"] == "error" ? 'class="subtwohober"' : '' ?>>
            ...
            <li>
               ...
               <ul class="sub-menu">
                  <li <?= isset($_GET["pagina"]) && $_GET["pagina"] == "blog" ? 'class="subtwohober"' : '' ?>>
                     <a href="index.php?pagina=blog">
                        <span>Blog</span>
                     </a>
                  </li>
                  <li <?= isset($_GET["pagina"]) && $_GET["pagina"] == "blog-single" ? 'class="subtwohober"' : '' ?>>
            ...
            <li <?= isset($_GET["pagina"]) && $_GET["pagina"] == "contact" ? 'class="active"' : '' ?>>
    ...
    <div class="continer py-5">
      ...
      if (isset($_GET["pagina"])) {
        if (
          ...
          $_GET["pagina"] == "inicio" ||
          $_GET["pagina"] == "editar" ||
          $_GET["pagina"] == "salir" || // agregados del proyecto
          $_GET["pagina"] == "index" ||
          $_GET["pagina"] == "about" ||
