...
<head>
   ...
   <script src="https://kit.fontawesome.com/71ab9a7a67.js" crossorigin="anonymous"></script>
</head>
      ...
      <div class="continer py-5">
         ...
         if (isset($_GET["pagina"])) {
            if (
               ...
               $_GET["pagina"] == "salir" ||
               $_GET["pagina"] == "editar"||
               $_GET["pagina"] == "index" || // Actualizacion
               $_GET["pagina"] == "about" ||
            ...
            <div class="row g-4 justify-content-center">
               <div class="col-lg-12">
                  <div class="banner__content center">
                     ...
                     <h1 class="wow fadeInDown" data-wow-duration="4s">Jesus y Abigail</h1>
